...
public class EFXSchmiedeMeister extends Effect implements EFXProduction {

	/** Konstruktor für Reflection */
	public EFXSchmiedeMeister() { super(); }
	
	public EFXSchmiedeMeister(Unit unit)
	{
	...
	public int EFXCalculate(Unit unit, Item item, int anzahl) {
		...
		if (!building.getClass().equals(Schmiede.class)) return 0; // in keiner Schmiede
		...
		// Meldung
		new Magie(unit + " produziert durch seine Erfahrung in der Schmiede " + extra + " " + item.getName() + " mehr", unit);
