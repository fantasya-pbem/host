...
public class Sattlerei extends Building
{
	...
	public String getTyp() { return "Sattlerei"; }
	...
	public void Mache(Unit u)
	{
		...
		GenericMake(u, 0, Burgenbau.class, 4, new Item [] { new Stein(2), new Eisen(6), new Holz(4), new Silber(250) } );
	}

	@Override
	public ComplexName getComplexName() {
		return new ComplexName("Sattlerei", "Sattlereien", null);
	}
}
