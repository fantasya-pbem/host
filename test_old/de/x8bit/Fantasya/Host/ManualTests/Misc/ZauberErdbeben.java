 ...
 * @author hb
 */
public class ZauberErdbeben extends TestBase {
    ...
    protected void mySetupTest() {
...

        {
			...
			p2.setName("Z-Erdbeben");

			Unit magier = this.createMage(p2, r, 6);
			magier.setName(this.getName() + " 02 " + magier.getAura());
			magier.setSpell(new Erdbeben());
			magier.Befehle.add("ZAUBERE \"Erdbeben\" 4");
			...
			magier.setSpell(new Erdbeben());
			magier.setProperty(Kampfzauber.CONFUSIONSPELL, "Erdbeben 4");
        ...
        for (Unit u:units) {
            ...
            if (tokens[1].equals("01")) {
                ...
                for (Message msg : messages) {
                    ...
                    if (text.contains("wurde durch das erdbeben") && text.contains("besch")) found = true; // besch...ädigt
                }
