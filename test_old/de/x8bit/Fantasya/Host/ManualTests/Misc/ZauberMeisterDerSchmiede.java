 ...
 * @author hb
 */
public class ZauberMeisterDerSchmiede extends TestBase {
    ...
    protected void mySetupTest() {
...

        {
			...
			p2.setName("Z-MeisterDerSchmiede");
        ...
        for (Unit u:units) {
            ...
            if (tokens[1].equals("01")) {
                ...
                for (Message msg : messages) {
                    ...
                    if (text.contains("durch seine erfahrung") && text.contains("1 schwerter mehr")) found = true;
                }
                if (!found) retval = fail(tokens[1] + ": Meldung über magische Hilfe fehlt.");

				if (u.getItem(Schwert.class).getAnzahl() != 10) {
