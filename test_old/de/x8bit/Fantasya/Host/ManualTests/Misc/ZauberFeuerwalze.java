 ...
 * @author hb
 */
public class ZauberFeuerwalze extends TestBase {
    ...
    protected void mySetupTest() {
...

        {
			...
			p2.setName("Z-Feuerwalze");

			Unit magier = this.createMage(p2, r, 6);
			magier.setName(this.getName() + " 02 " + magier.getAura());
			magier.setSpell(new Feuerwalze());
			magier.Befehle.add("ZAUBERE \"Feuerwalze\" 4");
			...
			magier.setSpell(new Feuerwalze());
			magier.setProperty(Kampfzauber.ATTACKSPELL, "Feuerwalze");
