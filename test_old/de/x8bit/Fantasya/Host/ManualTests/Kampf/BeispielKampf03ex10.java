 ...
 * @author hb
 */
public class BeispielKampf03ex10 extends TestBase {
    ...
    protected void mySetupTest() {
...

        {
            ...
            genauePikeniere.setPersonen(100);
...
//            String idA = genauePikeniere.getNummerBase36();
            ...
            b.setItem(Katapult.class, b.getPersonen());
            ...
            String idBogenschuetzen = b.getNummerBase36();
            ...
            schuetzen.Befehle.add("ATTACKIERE GEZIELT " + idKatapultschuetze + " " + idBogenschuetzen);
