 ...
 * @author hb
 */
public class Schlacht100Pegasi extends TestBase {
    ...
    protected void mySetupTest() {
        ...
        pb.setName("Infanteristen");
        Partei pc = tw.createPartei(Mensch.class);
        pc.setName("Beobachter-Partei");
        ...
        {
            setupAngreifer(pa, 100); // zweite Parameter jeweils: Multiplikator der Mann-Stärken
            setupVerteidiger(pb, 300);
    ...
    protected void setupAngreifer(Partei p, int f) {
        Unit u = createSchwertkaempfer(p, "Flieger", f, Kampfposition.Vorne, 5);
    ...
    protected void setupVerteidiger(Partei p, int f) {
        Unit u = createSchwertkaempfer(p, "Steher", f, Kampfposition.Vorne, 8);
