 ...
 * @author hb
 */
public class GibNull extends TestBase {
    ...
    protected void mySetupTest() {
...

        {
			...
			u.Befehle.add("GIB 0 2000000 Silber");
			u.Befehle.add("GIB 0 1000 Pferde");
			u.Befehle.add("GIB 0 1000 Elefanten");
			u.Befehle.add("GIB 0 1000 Kamele");
			u.Befehle.add("GIB 0 1000 Eisen");
			u.Befehle.add("GIB 0 1000 Steine");
			u.Befehle.add("GIB 0 2000 Holz");
...

        {
			...
			u.Befehle.add("GIB 0 Silber");
			u.Befehle.add("GIB 0 Pferde");
			u.Befehle.add("GIB 0 Elefanten");
			u.Befehle.add("GIB 0 Kamele");
			u.Befehle.add("GIB 0 Eisen");
			u.Befehle.add("GIB 0 Steine");
			u.Befehle.add("GIB 0 Holz");

			// Wir wollen nicht mehr!
			u = this.createUnit(p, r);
			u.setItem(Silber.class, 0); // damit nicht das Erbe die Test-Ergebnisse verfälscht
			u.setPersonen(10);
			u.setName(this.getName() + " 04");
			u.Befehle.add("GIB 0 10 PERSONEN");
			...
			for (Paket pack : Paket.getPaket("Items")) {
				Item item = (Item)pack.Klasse;
				u.setItem(item.getClass(), 11);
				u.Befehle.add("GIB 0 " + item.getName());
			}
    ...
    protected boolean verifyTest() {
        ...
        for (Unit u:units) {
			...
			if (tokens[1].equals("05")) {
				for (Paket pack : Paket.getPaket("Items")) {
					if (u.getItem((Class<? extends Item>) pack.Klasse.getClass()).getAnzahl() > 0) {
						retval = fail(tokens[1] + " ([" + u.getNummerBase36() + "] von [" + p.getNummerBase36() + "]) hat noch " + pack.Klasse.getName() + ".");
					}
				}
			}
